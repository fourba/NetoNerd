				...
				<div class="column-2-3">
					<nav class="footer-nav">
						<ul>
							...
							<a href="#" onclick="$('#fh5co-features').goTo();return false;"><li>Dicas</li></a>
							<a href="#" onclick="$('#fh5co-reviews').goTo();return false;"><li>Chamados populares</li></a>
							<a href="../index.html" onclick="$('#fh5co-reviews').goTo();return false;"><li>Four_BA</li></a>
							<a href="index.html" onclick="$('#fh5co-download').goTo();return false;"><li class="active">Login</li></a>
						</ul>
					</nav>
				</div>
